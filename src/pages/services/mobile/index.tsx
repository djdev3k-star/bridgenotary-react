  ...
  return (
    <div>
      ...
      <div className="relative overflow-hidden text-white min-h-[75vh] md:min-h-[85vh] flex items-center w-screen left-1/2 -translate-x-1/2">
        ...
        <div className="absolute inset-0 bg-professional-blue/50"></div>
      ...
      <div className="section">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {features.map((f) => (
              <div key={f.title} className="border-l-2 border-professional-blue pl-6 group">
                <div className="flex items-start gap-3 mb-3">
                  <div className="text-professional-blue group-hover:scale-110 transition-transform flex-shrink-0">
                    {f.icon}
                  </div>
                  <h3 className="text-xl font-semibold text-charcoal">{f.title}</h3>
                </div>
                <p className="text-charcoal/70">{f.description}</p>
              </div>
            ))}
          </div>

          <div className="border-l-2 border-professional-blue pl-6 py-6 mb-10">
            <h2 className="text-2xl font-bold text-charcoal mb-3">Common Documents We Notarize</h2>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <div className="border-l-2 border-professional-blue pl-6 py-6 md:w-1/2">
              <h3 className="text-xl font-semibold text-charcoal mb-2">How It Works</h3>
              <ol className="space-y-3">
                {[
                  ...
                  <li key={step} className="flex items-start gap-3">
                    <span className="text-professional-blue font-bold flex-shrink-0">{i + 1}.</span>
            ...
            <div className="border-l-2 border-professional-blue pl-6 py-6 md:w-1/2">
              <h3 className="text-xl font-semibold text-charcoal mb-2">Pricing Snapshot</h3>
              <ul className="space-y-2">
                <li className="flex justify-between"><span className="text-charcoal/70">Standard Notarial Act</span><span className="text-charcoal font-semibold">$10</span></li>
                <li className="flex justify-between"><span className="text-charcoal/70">Travel (local)</span><span className="text-charcoal font-semibold">From $25</span></li>
                <li className="flex justify-between"><span className="text-charcoal/70">After-hours / Weekend</span><span className="text-charcoal font-semibold">+ $20</span></li>
              </ul>
              <p className="text-charcoal/70 mt-3 text-sm">Exact pricing depends on location, document count, and timing. See full pricing for details.</p>
              <div className="mt-4">
