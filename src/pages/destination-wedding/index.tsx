    ...
    <Layout>
      ...
      <section className="bg-off-white border-b border-charcoal/10">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center gap-2 text-sm text-charcoal/70">
            ...
            <span>/</span>
            <span className="text-charcoal font-medium">Destination Wedding</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-off-white">
        <div className="max-w-6xl mx-auto px-6 mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6">Common Destination Wedding Documents</h2>
          <p className="text-xl text-charcoal/70 max-w-3xl">We help authenticate and certify documents for international wedding ceremonies and legal recognition abroad.</p>
        </div>
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="border-l-2 border-professional-blue pl-6 py-4 group">
            ...
            <h3 className="text-lg font-bold text-charcoal mb-2">Marriage Documents</h3>
          ...
          <div className="border-l-2 border-professional-blue pl-6 py-4 group">
            ...
            <h3 className="text-lg font-bold text-charcoal mb-2">Wedding Materials</h3>
            <ul className="text-charcoal/70 text-sm space-y-1">
