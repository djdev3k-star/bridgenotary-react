    ...
    <div className="bg-off-white font-sans">
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="w-10 h-10 bg-professional-blue rounded flex items-center justify-center mr-3">
              ...
              <h1 className="text-2xl font-bold text-charcoal">Bridge Notary Pro</h1>
            </div>
            <div className="text-sm text-charcoal/70">Your Success Solution Kit</div>
          </div>
        </div>
      </header>

      {/* Hero Section */}
      <section className="relative bg-professional-blue text-white py-16">
      ...
      <section className="section">
        <div className="text-center mb-12 fade-in">
          <h3 className="text-4xl font-bold text-charcoal mb-4">Does This Sound Familiar?</h3>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="card fade-in">
            ...
            <h4 className="text-xl font-bold text-charcoal mb-4">"I'll call you back..."</h4>
          ...
          <div className="card fade-in-delay">
            ...
            <h4 className="text-xl font-bold text-charcoal mb-4">The Client That Slipped Away</h4>
            <p className="text-charcoal/70">
          ...
          <div className="card fade-in">
            ...
            <h4 className="text-xl font-bold text-charcoal mb-4">"Am I Doing This Right?"</h4>
            <p className="text-charcoal/70">
      ...
      {/* Lead Capture Form */}
      <section ref={leadFormRef} className="relative bg-professional-blue text-white py-16">
        {/* Background image with overlay */}
        <div className="absolute inset-0 opacity-20">
          <img 
            src="/src/assets/images/stack-loan-documents.jpg" 
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center fade-in">
            ...
            <div className="card text-charcoal">
              <div className="space-y-6">
                <div>
                  <label htmlFor="firstName" className="block text-left font-semibold mb-2">First Name</label>
                  <input type="text" id="firstName"
                    className="w-full px-4 py-3 border border-professional-blue/20 rounded focus:ring-2 focus:ring-professional-blue focus:border-transparent"
                ...
                <p className="text-sm text-charcoal/70">100% Free • No spam • Instant access</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-charcoal text-white py-8">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <div className="mb-4">
            ...
            <p className="text-charcoal/70">Helping notaries build professional, profitable businesses from day one.</p>
          </div>
          <p className="text-charcoal/70 text-sm">© 2025 Bridge Notary Pro. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
