...
const About = () => (
  <div className="w-full bg-off-white">
    {/* Hero Section */}
    <section className="relative overflow-hidden bg-professional-blue/10 text-charcoal w-full py-24 md:py-32">
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="p-6 border-l-2 border-professional-blue group hover:bg-professional-blue/5 transition-colors">
              <h4 className="font-bold text-charcoal text-lg mb-2">Reliability</h4>
              <p className="text-charcoal/70 leading-relaxed text-sm">We show up on time, prepared, and ready. Our 99% on-time rate is our standard, not a marketing claim.</p>
            </div>
            <div className="p-6 border-l-2 border-professional-blue group hover:bg-professional-blue/5 transition-colors">
              <h4 className="font-bold text-charcoal text-lg mb-2">Accuracy</h4>
              <p className="text-charcoal/70 leading-relaxed text-sm">We get documents right the first time. Missing signatures cost money—we prevent them.</p>
            </div>
            <div className="p-6 border-l-2 border-professional-blue group hover:bg-professional-blue/5 transition-colors">
              <h4 className="font-bold text-charcoal text-lg mb-2">Communication</h4>
              <p className="text-charcoal/70 leading-relaxed text-sm">From booking to completion, we keep everyone informed. No surprises, no missed details.</p>
            </div>
          </div>
    ...
    <section className="py-20 lg:py-28 bg-off-white" style={{backgroundImage: 'repeating-linear-gradient(90deg, transparent, transparent 2px, rgba(0, 85, 230, 0.02) 2px, rgba(0, 85, 230, 0.02) 4px)'}}>
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {/* Mission */}
          <div className="p-10 border-l-2 border-professional-blue group hover:bg-professional-blue/5 transition-colors">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-2xl font-bold text-charcoal">Our Mission</h3>
            </div>
            <p className="text-charcoal/70 leading-[1.8] text-base">
          ...
          <div className="p-10 border-l-2 border-professional-blue group hover:bg-professional-blue/5 transition-colors">
            <div className="flex items-start gap-4 mb-4">
              ...
              <h3 className="text-2xl font-bold text-charcoal">Our Vision</h3>
            </div>
            <p className="text-charcoal/70 leading-[1.8] text-base">
    ...
    <section className="py-20 lg:py-28 bg-professional-blue/10">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-14">
          <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-4">What Guides Us</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={value.title} className="p-8 border-l-2 border-professional-blue group hover:bg-professional-blue/5 transition-colors">
              ...
              <p className="text-charcoal/70 leading-[1.7]">{value.desc}</p>
            </div>
          ))}
        </div>
      </div>
    ...
    {/* CTA Section */}
    <section className="py-24 lg:py-32 bg-professional-blue/10 text-charcoal w-full flex items-center justify-center">
