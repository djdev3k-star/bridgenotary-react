    ...
    <>
        ...
        <div className="w-full relative z-30 px-6 py-24">
          <div className="mx-auto text-center max-w-4xl">
            <div className="fade-in mb-8">
              ...
              <Link to={ctaLink} className="inline-block bg-white text-proof hover:bg-neutral-100 transition-all rounded-lg text-lg py-5 px-12 font-semibold shadow-2xl transform hover:scale-105 hover:shadow-2xl">
      ...
      <div className="w-full bg-white">
          ...
          <div className="max-w-4xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="fade-in-delay grid grid-cols-1 gap-4">
                <div className="bg-proof/5 rounded-xl p-6 border-l-4 border-electric-blue">
        ...
        <section className="py-20 lg:py-28 bg-neutral-50">
          <div className="max-w-4xl mx-auto px-6">
            <div className="bg-white rounded-2xl shadow-lg p-10 border-l-4 border-electric-blue">
        ...
        <section className="py-20 lg:py-28">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <Link to={ctaLink} className="inline-block bg-electric-blue hover:bg-electric-blue/90 text-white font-semibold py-4 px-12 rounded-lg text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all">
              {ctaText} Now
            </Link>
          </div>
        </section>
        ...
        <section className="py-20 lg:py-28 bg-proof text-white">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Link to="/loan-signing/refinance" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-lg p-6 border border-white/20 transition-all transform hover:scale-105">
              ...
              <Link to="/loan-signing/purchase" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-lg p-6 border border-white/20 transition-all transform hover:scale-105">
              ...
              <Link to="/loan-signing/seller" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-lg p-6 border border-white/20 transition-all transform hover:scale-105">
              ...
              <Link to="/loan-signing/reverse" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-lg p-6 border border-white/20 transition-all transform hover:scale-105">
              ...
              <Link to="/loan-signing/heloc" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-lg p-6 border border-white/20 transition-all transform hover:scale-105">
              ...
              <Link to="/loan-signing/commercial" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-lg p-6 border border-white/20 transition-all transform hover:scale-105">
