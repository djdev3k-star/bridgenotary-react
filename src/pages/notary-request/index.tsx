  ...
  <div className="w-full bg-white">
    ...
    <section className="py-8 md:py-12 px-4 md:px-6 border-b border-professional-blue/20">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold text-charcoal">Notary Service Request</h1>
      </div>
    </section>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-off-white border-l-4 border-professional-blue p-4">
            ...
            <div className="space-y-1 text-sm text-charcoal/70">
              ...
              <p className="text-xs text-professional-blue mt-3">RON available 24/7</p>
            </div>
          </div>
          ...
          <div className="bg-off-white border-l-4 border-professional-blue p-4">
            ...
            <p className="text-xs text-charcoal/60 mt-2">Mobile and online services available</p>
          </div>
        </div>
      </div>
    </section>
