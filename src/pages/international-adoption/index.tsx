    ...
    <>
      ...
      <section className="relative overflow-hidden text-white min-h-[600px] flex items-center w-screen left-1/2 -translate-x-1/2">
        ...
        <div className="absolute inset-0 z-0 opacity-50">
          <img src={internationalAdoptionImage} alt="" className="w-full h-full object-cover" />
        </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="border-l-2 border-professional-blue pl-6 group">
                ...
                <h3 className="text-xl font-bold text-charcoal mb-3">Family Documentation</h3>
                <ul className="space-y-2 text-charcoal/70 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>Divorce Decrees & Custody</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="border-l-2 border-professional-blue pl-6 group">
                ...
                <h3 className="text-xl font-bold text-charcoal mb-3">Home Study & Verification</h3>
                <ul className="space-y-2 text-charcoal/70 text-sm">
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-professional-blue flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              ...
              <div className="border-l-2 border-professional-blue pl-6 group">
                ...
                <h3 className="text-xl font-bold text-charcoal mb-3">Agency & Legal Documents</h3>
                <ul className="space-y-2 text-charcoal/70 text-sm">
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-professional-blue flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>Agency Referral Letters</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-professional-blue flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span>Court Orders & Decrees</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 text-professional-blue flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="bg-professional-blue/5 border border-professional-blue/20 rounded-lg p-8 md:p-12">
              <h3 className="text-2xl font-bold text-charcoal mb-8">Dossier Preparation Process</h3>
              <div className="grid md:grid-cols-4 gap-6">
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Consultation</h4>
                  <p className="text-sm text-charcoal/70">Review country-specific requirements with our team</p>
                </div>
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Document Collection</h4>
                  <p className="text-sm text-charcoal/70">Gather all required records for your dossier</p>
                </div>
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Apostille & Auth</h4>
                  <p className="text-sm text-charcoal/70">Official certification for all documents</p>
                </div>
                <div className="text-center">
                  ...
                  <h4 className="font-semibold text-charcoal mb-2">Dossier Ready</h4>
                  <p className="text-sm text-charcoal/70">Complete dossier submitted to authorities</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Unique Element: Adoption Dossier Checklist */}
      <section className="py-20 lg:py-28 bg-professional-blue/5 border-t border-professional-blue/20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-6">Complete Dossier Checklist</h2>
            <p className="text-lg text-charcoal/70 max-w-2xl mx-auto">A comprehensive guide to ensure you have all documents needed for your adoption dossier</p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-8 border border-professional-blue/20">
              ...
              <div className="space-y-3">
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Birth Certificates (parents & child if available)</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Marriage Certificate</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Divorce/Custody Documents (if applicable)</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Passport/ID Pages</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Medical Exams & Clearances</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Home Study Report</span>
                </label>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-8 border border-professional-blue/20">
              ...
              <div className="space-y-3">
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Background Check Results</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Financial Statements (2+ years)</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Employment Letters</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Agency Referral Letters</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Personal References</span>
                </label>
                <label className="flex items-start gap-3 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 mt-1 accent-professional-blue" />
                  <span className="text-charcoal text-sm group-hover:text-professional-blue transition-colors">Court Orders & Decrees</span>
                </label>
              </div>
            </div>
          </div>

          <div className="mt-12 bg-professional-blue/10 rounded-lg p-8 border border-professional-blue/30">
            <div className="flex items-start gap-4">
              <svg className="w-6 h-6 text-professional-blue flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <div>
                <h4 className="font-semibold text-charcoal mb-2">Important Note</h4>
                <p className="text-charcoal/70 text-sm">Requirements vary by country. We provide country-specific guidance. Every document should be apostilled by the issuing authority and certified for international use. Contact us for your specific country requirements.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Link to="/study-abroad" className="border-l-2 border-professional-blue pl-6 py-6 group hover:bg-white hover:shadow-md rounded transition-all">
              ...
              <p className="text-charcoal/70 mb-6 text-base leading-relaxed">Certify academic records and transcripts for international university applications</p>
              <span className="inline-flex items-center gap-2 text-professional-blue font-semibold group-hover:gap-3 transition-all">
                Learn more
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
      ...
      <section className="py-20 lg:py-28 bg-professional-blue">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Complete Your Adoption Dossier Today</h2>
          <p className="text-xl text-white/90 mb-10 leading-relaxed max-w-2xl mx-auto">
            Our adoption specialists understand the urgency and complexity of international adoption documentation. Let us handle your apostille needs.
          </p>
