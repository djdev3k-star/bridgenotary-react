...
const Contact = () => {
  ...
  return (
    <div className="w-full">
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-professional-blue/10 px-4 py-2 text-sm font-medium mb-6 border border-professional-blue/20">
              ...
              <span className="text-professional-blue">Get in Touch</span>
            </div>
            ...
            <p className="text-base md:text-lg text-charcoal/70 leading-relaxed">
              Have questions about our services? Ready to schedule an appointment? Reach out to us—we're here to help with all your notarization needs.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Main Content */}
      <section className="py-12 lg:py-24 bg-white" style={{backgroundImage: 'repeating-linear-gradient(90deg, transparent, transparent 2px, rgba(0, 85, 230, 0.02) 2px, rgba(0, 85, 230, 0.02) 4px)'}}>
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-3 gap-8 md:gap-12">
            {/* Left Column - Form */}
            <div className="lg:col-span-2">
              <form className="bg-white border border-professional-blue/20 p-4 md:p-8 lg:p-10" onSubmit={handleSubmit} noValidate>
                <h2 className="text-xl md:text-2xl font-bold text-charcoal mb-4 md:mb-6">Send Us a Message</h2>
      ...
      {/* Map / CTA Section */}
      <section className="py-16 bg-professional-blue/10 border-t border-professional-blue/20" style={{backgroundImage: 'repeating-linear-gradient(90deg, transparent, transparent 2px, rgba(0, 85, 230, 0.02) 2px, rgba(0, 85, 230, 0.02) 4px)'}}>
