    ...
    <Layout>
        ...
        <div className="max-w-7xl mx-auto py-20 px-6 relative z-20 w-full">
          <div className="max-w-3xl text-left">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xs uppercase tracking-[0.25em] text-white/90">International Adoption</span>
              <span className="h-px w-12 bg-white/50"></span>
            </div>
      ...
      <section className="section bg-white">
        <div className="mb-10">
          ...
          <h2 className="text-3xl font-bold text-proof">Common International Adoption Documents</h2>
          <p className="text-lg text-neutral-600 mt-3">We help compile and authenticate documents required by foreign central authorities and courts.</p>
        </div>
