...
const Services = () => {
  ...
  return (
    <div className="w-full bg-professional-blue/10 pt-20">
      {/* Hero Section */}
      <section className="py-16 md:py-20 border-b border-professional-blue/20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* Trust Markers */}
          <div className="flex flex-wrap gap-6 mt-8 pt-8 border-t border-professional-blue/20">
      ...
      <section className="py-12 md:py-20 bg-white relative" style={{backgroundImage: 'repeating-linear-gradient(90deg, transparent, transparent 2px, rgba(0, 85, 230, 0.02) 2px, rgba(0, 85, 230, 0.02) 4px)'}}>
        <div className="max-w-6xl mx-auto px-6">
          {/* Tabs */}
          ...
          {/* Tab Content */}
          {activeCategory && (
            <div className="bg-white border-l-2 border-professional-blue pl-6 py-8 md:py-12 pr-8 relative z-10">
              <div className="mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {activeCategory.services.map((service) => (
                  <Link
                    key={service.name}
                    to={service.link}
                    className="pl-4 py-4 border-l-2 border-professional-blue/50 hover:border-professional-blue group hover:bg-professional-blue/5 transition-all"
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <h3 className="font-semibold text-lg text-charcoal group-hover:text-professional-blue transition-colors">{service.name}</h3>
                        <p className="text-professional-blue font-bold mt-1">{service.price}</p>
                      </div>
                      <svg className="w-5 h-5 text-professional-blue opacity-0 group-hover:opacity-100 transition-opacity mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* CTA Section */}
      <section className="py-20 md:py-28 bg-professional-blue">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/book" className="inline-flex items-center justify-center gap-2 bg-off-white text-professional-blue hover:bg-off-white/90 font-bold py-4 px-8 text-lg shadow-lg transition-all">
              Book Online Now
            </Link>
            <a href="tel:+14696298932" className="inline-flex items-center justify-center gap-2 border-2 border-off-white text-off-white hover:bg-off-white/10 font-bold py-4 px-8 text-lg transition-all">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
