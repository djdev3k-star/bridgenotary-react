...
const Services = () => (
  <div>
    ...
    <section className="py-16 px-6 bg-gradient-to-r from-proof/10 to-electric-blue/10">
      <div className="max-w-6xl mx-auto">
    ...
    <section className="py-16 px-6 bg-neutral-50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Link to="/ron" className="bg-white rounded-xl shadow-md p-8 border border-neutral-200 hover:shadow-lg transition-all">
          ...
          <Link to="/apostille" className="bg-white rounded-xl shadow-md p-8 border border-neutral-200 hover:shadow-lg transition-all">
            <h3 className="text-xl font-bold text-proof mb-4 flex items-center gap-2">
              <svg className="w-6 h-6 text-electric-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <Link to="/loan-signing" className="bg-white rounded-xl shadow-md p-8 border border-neutral-200 hover:shadow-lg transition-all">
            <h3 className="text-xl font-bold text-proof mb-4 flex items-center gap-2">
              <svg className="w-6 h-6 text-electric-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section className="py-16 px-6 bg-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-neutral-700 italic mb-6">
          "Bridge Notary is dependable, professional, and always communicates throughout the process. Their attention to detail and prompt service have made them our go-to notary service. Highly recommended!"
        </p>
        <p className="text-lg font-semibold text-proof">- Escrow Officer, Dallas TX</p>
      </div>
    </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <a href="tel:+14696298932" className="flex items-center gap-3 text-neutral-700 hover:text-electric-blue transition-colors group">
                  <div className="bg-electric-blue/10 p-3 rounded-full group-hover:bg-electric-blue/20 transition-colors">
                    <svg className="w-5 h-5 text-proof" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
            ...
            <div className="flex justify-center">
              <div className="space-y-6">
                <Link to="/book" className="block w-full bg-electric-blue text-white py-4 px-8 rounded-lg text-center hover:bg-blue-700 transition-colors text-lg font-medium">
                  Book a Signing
                </Link>
                <Link to="/contact" className="block w-full border-2 border-proof text-proof py-4 px-8 rounded-lg text-center hover:bg-proof/5 transition-colors text-lg font-medium">
                  Contact Sales
                </Link>
              </div>
            </div>
