        ...
        <div className="grid lg:grid-cols-3 gap-6 items-start">
          ...
          <div className={`lg:col-span-1 space-y-6 ${activeTab === "documents" ? "block" : "hidden lg:block"}`}>
            ...
            <div className="bg-white rounded-xl border border-neutral-200 shadow-sm overflow-hidden">
              <div className="bg-gradient-to-r from-professional-blue to-professional-blue p-4">
              ...
              <div className="p-5">
                <label className="block border-2 border-dashed border-neutral-300 rounded-xl p-6 text-center cursor-pointer hover:border-professional-blue hover:bg-professional-blue/5 transition group">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div>
                      <p className="text-charcoal font-medium">Click to upload</p>
